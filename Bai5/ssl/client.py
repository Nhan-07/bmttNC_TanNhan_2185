...
context.verify_mode = ssl.CERT_NONE  # Không xác minh chứng chỉ (chỉ dùng cho phát triển)
context.check_hostname = False       # Không kiểm tra hostname (chỉ dùng cho phát triển)
